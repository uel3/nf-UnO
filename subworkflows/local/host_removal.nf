...
HOST_REMOVAL {
    ...
    emit:
        ...
        verify_logs = BT2_HOST_REMOVAL_VERIFY.out.log    // Verification logs
        versions = BT2_HOST_REMOVAL_ALIGN.out.versions.mix(BT2_HOST_REMOVAL_VERIFY.out.versions)
}
