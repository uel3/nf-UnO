...
12. ([`AMRFinderPlus`](https://github.com/ncbi/amr)) is used to identify elments, such as AMR genes, in bins.
13. ([`MultiQC`](http://multiqc.info/)) is used to summarize some of the findings and software versions.
